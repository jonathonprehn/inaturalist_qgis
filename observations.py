...
class Observation:
    ...
    # - parsing a list of observations from 
    #   the results of an Observation search query
...
class ObservationSearchQuery:
    ...
    def __init__(self, apiRoot):
        ...
        self.per_page = 10   # Number of results to return in a page. The maximum value is generally 200 unless otherwise noted
